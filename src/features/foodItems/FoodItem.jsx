      ...
      {count > 0 && visible == true && (
        <div className="side_menu">
                ...
                <div>
                  ...
                  <div className="actions">
                    <div className="actions_btn">
                      <div className="action_first" onClick={() => {setCount(count - 1);setNewPrice(originalPrice*(count-1))}}>-</div>
                      <div className="action_second">{count}</div>
                      <div className="action_third" onClick={() => {setCount(count + 1);setNewPrice(originalPrice*(count+1))}}>+</div>
                    </div>
                  </div>
          ...
          <div className="upsale">
              ...
              <div className="upsale_product">
                <div className="image_preloaded">
                  <img src="https://d3gy1em549lxx2.cloudfront.net/47d581cf-8e33-46e7-942e-1f2f832b368b.JPG" width={75} height={75} />
                </div>
                <div className="info">
                  <div className="product_title">
                    <div className="veg_icon">
